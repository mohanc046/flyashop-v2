...
const Statistics = (props) => {
            ...
            <div className="banner-container">
                ...
                <div className="header d-flex justify-content-between align-items-center">
                    ...
                    <div className="btn-grp">
                        <button className="btn btn-no-bg" onClick={() => navigate('/pricing-list')}>Solutions</button>
                        <button className="btn btn-no-bg" onClick={() => navigate('/pricing-list')}>Pricing</button>
                        <button className="btn btn-no-bg" onClick={() => navigate('/logout')}>Login</button>
                    ...
                    {
                        openMenu && <div className="position-fixed top-0 end-0 bottom-0 start-0 z-2 bg-body" onClick={() => setOpenMenu(false)}>
                            <Menu className="pt-5 ps-4" items={[
                                {
                                    label: <button className="btn btn-white-bg" onClick={() => navigate('/pricing-list')}>Solutions</button>
                                },
                                {
                                    label: <button className="btn btn-white-bg" onClick={() => navigate('/pricing-list')}>Pricing</button>

                                },
                                {
                                    label: <button className="btn btn-primary-color-bg" onClick={() => navigate('/logout')}>Login</button>
                                }
                            ]} />
                        </div>
                    }
                ...
                <Row>
                    <Col lg={{ span: 12 }} span={24} className="content">
                        <h4 className="title">Your global online shop, Its <span className="color-majorelle-blue">here</span></h4>
                        <p className="description">Get your awesome global online video shop in 30 seconds and manage customers, payments, shipping, social, marketplace, analytics via one app.</p>
                    </Col>
    ...
    const renderStatsContainer = () => {
        return (
            <Row className="stats-container-content mt-5">
                ...
                <p className="title">from <span className="color-majorelle-blue">hey people</span> to a billion dollar <span className="color-majorelle-blue">unicorn</span>.</p>
    ...
    const renderWays = () => {
        return (
            <div className="ways-container">
                ...
                <h4 className="desc">Let your customers experience the power of videos to shop for your products and services.</h4>
                <Segmented
                    defaultValue="center"
                ...
                <div className="steps d-flex align-items-center">
                    <div className="steps-description">
                        ...
                        <li><p className="step">The nights you’ve lost, the fights you’ve fought... to find the perfect name.</p></li>
                        <li><p className="step">Now is the time to make it happen.</p></li>
                        <li><p className="step">Name your shop, choose a category and say a prayer.</p></li>
                        <li><p className="step">Let the world know what you have to offer.</p></li>
                        <li><p className="step">Name your shop, choose a category and pay simply.</p></li>
                    </div>
                        ...
                        <div className="content">
                            <div className="step-card">
                                ...
                                <div className="details d-flex flex-column justify-content-center">
                                    ...
                                    <span><span className="price">$ 4</span> <span className="price stricked-out">$ 8</span> </span>
                                </div>
                            </div>
                            <div className="step-card">
                                ...
                                <div className="details d-flex flex-column justify-content-center">
                                    ...
                                    <span><span className="price">$ 3</span> <span className="price stricked-out">$ 5</span> </span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    const renderNextLevelEcommerce = () => {
        return (
            <div className="next-level d-flex flex-column align-items-center">
                ...
                <p className="description">With our cutting-edge technology, your business is now more agile, more intelligent and far more scalable than ever before</p>
                <div className="next-level-grid">
                    ...
                    <div className="next-level-grid-item d-flex flex-column align-items-center">
                        ...
                        <p className="description">Create your own online store within seconds. Share it via social media.</p>
                    </div>
                    <div className="next-level-grid-item d-flex flex-column align-items-center">
                        <div className="img-container d-flex align-items-center justify-content-center">
    ...
    const growOnlineShoppingCardView = () => {
        ...
        return <div className="grow-shopping-container">
            ...
            <div className="growShopParentContainer" >
                {_.map(data, (item, index) => <div className="growIndividualShopContainer">
    ...
    const customizationCardView = () => {
        return (<div className="customizeShopPlatformContainer">
            <label className="customizePlatformLabelContainer">The most customizable eCommerce platform for building your online business.</label>
            <div className="customizePlatformButtonParentContainer">
                <button className="customizePlatformButtonContainerButton" onClick={() => navigate('/login')}>
                    <label className="customizeButtonLabelContainer">
                        Get Started
                    </label>
                </button>
            </div>
    ...
    const renderEnhanceSite = () => {
        return (
            <Row className="enhance-site">
                ...
                <p className="description"> Choose from over 40+ plugins. Be it tracking analytics, managing shipments to building email lists. There's a plugin for everything.</p>
                <img src={config.ENHANCE_SITE_LOGOS} alt="" />
                <button className="btn btn-primary primary-color get-started" onClick={() => navigate('/login')}>Get Started</button>
            </Row>
        )
    }
        ...
        return (
            <div className="trusted-by">
                ...
                <div className="content">
                    ...
                    <div className="actions mt-5 justify-content-end" style={{ paddingRight: "80px", marginBottom: 30 }}>
                        <FontAwesomeIcon className="left" icon={faArrowLeft} />
                        <FontAwesomeIcon className="right" icon={faArrowRightLong} />
                    </div>
                    <div className="content-card">
                        <img src={config.DOUBLE_QUOTES} alt="" />
                        <span className="description">No other eCommerce platform allows people to start for free and grow their store as their business grows. More importantly, Shopstaar doesn't charge you a portion of your profits as your business grows!</span>
                    </div>
    ...
    const brands = [config.TECH_IN_ASIA_LOGO, config.FORBES_LOGO, config.TECH_CRUNCH_LOGO, config.FINANCIAL_TIMES_LOGO, config.BLOOMBERG_LOGO];
    const renderBrands = () => {
        return (
        ...
        return (
            <Row className="footer-container">
                ...
                <Col lg={14} span={24} className="left d-flex align-items-end">
                    <p className="">Get your awesome, seamless online shop in seconds and manage customers, payments, credit, shipping, social, marketplace via one app</p>
                </Col>
